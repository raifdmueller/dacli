...
| **Python Package Management** | Python dependencies must be managed using **uv** (https://github.com/astral-sh/uv) for fast, reliable dependency resolution and virtual environment management.
|===
